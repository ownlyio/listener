...
const web3Eth = new Web3("wss://eth-mainnet.alchemyapi.io/v2/n60TiXLxyxLjDkrPnw_mzx4GahkWWkSN");
const web3Bsc = new Web3(process.env.RPC_URL_BSC);
const web3Matic = new Web3(process.env.RPC_URL_MATIC);
...
// let collectionContract = new web3Eth.eth.Contract(
...
//     "0x804efc52BFa9B85A86219c191d51147566f3B327"
// );
//
